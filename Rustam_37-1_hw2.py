...
if day >= 21 and day <= 31 and month == 3 or day <= 21 and month == 4:
    print('Овен')
    ...
    print('Рак')
elif day >= 23 and  day <= 30 and month == 7 or day <= 21 and month == 8:
    print('Лев')
    ...
    print('Не удалось определить ваш знак зодиака! Пожалуйста, проверьте правильность ввода данных. День рождения не должен быть меньше 1 и выше 31, месяц рождения не должен быть меньше 1 и выше 12')
